...
/**
 * @file select.tsx
 * @description Select component - Estilo v0/Vercel moderno
 */
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex h-11 w-full items-center justify-between rounded-lg border px-4 py-2 text-sm transition-all duration-200',
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDown className={cn('h-4 w-4', isDark ? 'text-zinc-400' : 'text-slate-400')} />
