    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Corregir stock basado en conteo fisico</p>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-12 pl-10 pr-4 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none text-lg"
              />
            </div>
                ...
                {items.map((item) => {
                  ...
                  return (
                    <div key={item.varianteId} className="p-4 flex items-center gap-4">
                      ...
                      {/* Stock nuevo */}
                      <div className="w-24">
                        <label className="text-xs text-gray-500 block text-center mb-1">Conteo real</label>
                        <input
                          type="number"
                          value={item.stockNuevo}
                          onChange={(e) => handleUpdateStockNuevo(item.varianteId, parseInt(e.target.value) || 0)}
                          className="w-full h-10 px-2 border-2 border-gray-200 rounded-lg text-center font-medium focus:border-blue-500 focus:outline-none"
                          min="0"
                        />
                      </div>
        ...
        >
          ...
          <button
            ...
            className="w-full h-14 bg-blue-600 text-white rounded-xl font-semibold text-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
